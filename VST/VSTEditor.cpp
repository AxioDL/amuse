...
bool VSTEditor::open(void* ptr)
{
    ...
    WNDCLASSW notifyCls = {
        CS_HREDRAW | CS_VREDRAW, WindowProc, 0, 8, HINSTANCE(hInstance), nullptr, nullptr, nullptr, nullptr, L"VSTNotify"};
    RegisterClassW(&notifyCls);

    m_rootView = CreateWindowW(L"VSTNotify", L"", WS_CHILD, 0, 0, m_windowRect.right, m_windowRect.bottom, hostView, nullptr,
    ...
    m_collectionTree = CreateWindowW(
        WC_TREEVIEW, L"", WS_CHILD | WS_CLIPSIBLINGS | TVS_SHOWSELALWAYS | TVS_HASLINES | TVS_LINESATROOT | TVS_HASBUTTONS, 1,
    ...
    m_collectionAdd = CreateWindowW(WC_BUTTON, L"+", WS_CHILD | WS_CLIPSIBLINGS | BS_PUSHBUTTON, 1,
    ...
    m_groupListView = CreateWindowW(
        WC_LISTVIEW, L"", WS_CHILD | LVS_REPORT | LVS_SINGLESEL | LVS_SHOWSELALWAYS | LVS_NOCOLUMNHEADER | LVS_NOSORTHEADER,
